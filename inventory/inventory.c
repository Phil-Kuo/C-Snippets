 ...
 * 			if the part already exits or the database if 	*
 * 			full.											*
 ************************************************************/
 ...
 * 		   up the part in the database. If the part exists, 	*
...
/****************************************************************
 * update: Prompts the user to enter a part number, then looks 	*
 * 		   up the part in the database. If the part exists, 	*
