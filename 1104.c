...
void print_results(bool *straight, bool *flush, bool *four, bool *three, int * pairs);
...
main (int argc, char *argv[])
{
	...
	for (;;)
	{
		...
		print_results(&straight, &flush, &four, &three, &pairs);
	}
	return 0;
}
...
void 
read_cards(int num_in_rank[],int num_in_suit[])
{
	...
	for (suit = 0; suit < NUM_SUITS; suit += 1)
	{
		num_in_suit[suit] = 0;
	}
...
void
analyze_hand(int num_in_rank[], int num_in_suit[], bool *straight, bool *flush, bool *four, bool *three, int *pairs)
{
	int num_consec = 0;
	int rank, suit;
	...
	*pairs = 0;
	...
	for (; rank < NUM_RANKS && num_in_rank[rank] > 0; rank += 1)
	{
		num_consec++;
	}
	...
	for (rank = 0; rank < NUM_RANKS; rank += 1)
	{
...
void
print_results(bool *straight, bool *flush, bool *four, bool *three, int *pairs)
{
